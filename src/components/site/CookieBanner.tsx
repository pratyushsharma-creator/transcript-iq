...
export function CookieBanner() {
  ...
  return (
    // Non-blocking bottom bar. No backdrop overlay: the page content stays fully
    // visible and interactive underneath, so paid-ad landing pages are not
    // treated as gated/interstitial by ad-network landing-page review (Taboola).
    <div
      role="region"
