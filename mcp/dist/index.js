...
import { listTranscripts, listTranscriptsSchema, getTranscript, getTranscriptSchema, } from './tools/transcripts.js';
import { listEarnings, listEarningsSchema, getEarnings, getEarningsSchema, } from './tools/earnings.js';
import { listBlogPosts, listBlogPostsSchema, getBlogPost, getBlogPostSchema, } from './tools/blog.js';
import { listOrders, listOrdersSchema, draftContent, draftContentSchema, generateMeta, generateMetaSchema, suggestTags, suggestTagsSchema, } from './tools/admin.js';
import { createBlogPost, createBlogPostSchema, updateBlogPost, updateBlogPostSchema, createTranscript, createTranscriptSchema, updateTranscript, updateTranscriptSchema, createEarnings, createEarningsSchema, updateEarnings, updateEarningsSchema, publishContent, publishContentSchema, unpublishContent, unpublishContentSchema, } from './tools/write.js';
...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: TOOLS.map((t) => ({
        ...
        inputSchema: {
            type: 'object',
            properties: Object.fromEntries(Object.entries(t.inputSchema.shape).map(([key, schema]) => {
